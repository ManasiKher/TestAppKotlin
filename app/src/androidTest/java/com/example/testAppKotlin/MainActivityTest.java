...
public class MainActivityTest {
    ...
    public void mainActivityTest2() {
        ViewInteraction textView = onView(
                allOf(withId(R.id.tvTitle), withText("Beavers"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.tvDescription), withText("Beavers are second only to humans in their ability to manipulate and change their environment. They can measure up to 1.3 metres long. A group of beavers is called a colony"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.FrameLayout.class),
                                        0),
